...
typedef struct _sst {
    ...
    //pthread_mutex_t mr_lock; // NOTE: mutex for add thread in combination with cond_wait // used for part 2, replaced with
    //pthread_cond_t mr; // NOTE: conditional variable					  // original cv_lock mutex and cv cond
